...
function allowDrop(event) {
  ...
  function drag(event) {
    ...
    taskId = $(event.target).closest(".card.mb-3").attr("data-task-id");
  }
  ...
  $(document).ready(function() {
    $(".card.mb-3").on("dblclick", function(event) {
        ...
        window.location.href = "/jobs/edit/" + taskId;
    });
